...
test_segmentIntoCandidates = function()
   ...
   t('just a test', { 'just', 'a', 'test' })
   print('\nPreliminary lambda table verification passed.')
   ...
   local s_18 = 'Lets try one with an escaped\\ space'
